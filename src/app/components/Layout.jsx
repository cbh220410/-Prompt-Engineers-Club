...
function Layout() {
  ...
  return <div
    className={`atmo-shell min-h-screen ${isDarkTheme ? "bg-[radial-gradient(900px_420px_at_4%_-5%,rgba(37,99,235,0.16),transparent_52%),radial-gradient(980px_480px_at_110%_112%,rgba(99,102,241,0.16),transparent_52%)]" : "bg-[radial-gradient(900px_420px_at_4%_-5%,rgba(59,130,246,0.18),transparent_52%),radial-gradient(980px_480px_at_110%_112%,rgba(14,165,233,0.14),transparent_52%)]"}`}
  >
      <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-7xl flex items-center justify-between gap-2 md:gap-3">
          <img
    src={navLogo}
    alt="Prompt Engineers  Club"
    className="h-10 sm:h-12 md:h-[5.5rem] w-auto object-contain shrink-0"
  />
