  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Team Grid */}
        {loading && (
          <p className={`text-center mb-6 ${isDarkTheme ? "text-gray-400" : "text-slate-500"}`}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {!loading && !error && teamMembers.map((member, index) => {
            ...
            <ScrollReveal key={member._id} delay={(index % 3) * 80}>
              <div className={`group relative rounded-3xl p-[1px] transition-all duration-500 hover:-translate-y-2 ${isDarkTheme
                ? "bg-[linear-gradient(145deg,rgba(148,163,184,0.45),rgba(15,23,42,0.1)_40%,rgba(56,189,248,0.32))] shadow-[0_22px_65px_-40px_rgba(14,116,144,0.75)] hover:shadow-[0_32px_90px_-38px_rgba(14,165,233,0.68)]"
                : "bg-[linear-gradient(145deg,rgba(148,163,184,0.5),rgba(255,255,255,0.95)_45%,rgba(59,130,246,0.38))] shadow-[0_22px_56px_-38px_rgba(30,41,59,0.35)] hover:shadow-[0_32px_76px_-42px_rgba(59,130,246,0.38)]"}`}>
                ...
                <div className={`relative rounded-[calc(1.5rem-1px)] overflow-hidden backdrop-blur-xl border ${isDarkTheme
                  ? "bg-[linear-gradient(170deg,rgba(2,6,23,0.95),rgba(15,23,42,0.93))] border-white/10"
                  : "bg-[linear-gradient(170deg,rgba(255,255,255,0.96),rgba(248,250,252,0.95))] border-slate-200/90"}`}>
                    ...
                    {links.map((item) => {
                      ...
                      return (
                        <a
                          ...
                          className={`p-3 rounded-full border transition-all duration-200 ${enabled
                            ? isDarkTheme
                              ? "bg-white/15 border-white/35 hover:bg-cyan-300/20 hover:border-cyan-200/70 hover:-translate-y-0.5"
                              : "bg-white/85 border-slate-300/70 hover:bg-sky-100 hover:border-sky-300/80 hover:-translate-y-0.5"
                            : isDarkTheme
                              ? "bg-white/5 border-white/10 opacity-40 cursor-not-allowed"
                              : "bg-white/45 border-slate-300/60 opacity-40 cursor-not-allowed"}`}
                        >
